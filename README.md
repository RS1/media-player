...
<Player media={media} config={{
    actions: {
        ...
        onStateChanged: state =>
            console.log(`The media player state is now: ${JSON.stringify(state)}`),
    }
}} />
```
