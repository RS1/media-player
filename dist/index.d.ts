...
declare const useTrack: () => [
    MediaTrack | null,
    (track: number | RawMediaTrack | ((track: MediaTrack | null) => number | RawMediaTrack | null) | null) => void
];
/**
 * Use this hook to access the current playlist anywhere within the `MediaProvider`.
 * The value returned by this hook works the same way as `useState`, so you can use it to both read and update the playlist.
 * @example
 * ```js
 ...
 * return (
 *    <div>
 *       <button onClick={() => setPlaylist([])}>Clear playlist</button>
 *       <ul>
...
declare const usePlaylist: () => [
    MediaTrack[],
    (newPlaylist: RawMediaTrack[] | ((playlist: MediaTrack[]) => RawMediaTrack[])) => void
];
/**
